...
main(int argc, char *argv[])
{
  ...
  a8:	7ec58593          	addi	a1,a1,2028 # 890 <malloc+0x108>
  ac:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4fe:	3b6c8c93          	addi	s9,s9,950 # 8b0 <malloc+0x128>
 ...
 50c:	400b8b93          	addi	s7,s7,1024 # 908 <digits>
 ...
 632:	27a98993          	addi	s3,s3,634 # 8a8 <malloc+0x120>
        while(*s != 0){
 636:	85ee                	mv	a1,s11
