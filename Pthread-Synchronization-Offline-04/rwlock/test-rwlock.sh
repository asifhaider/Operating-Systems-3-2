...
g++ test-reader-pref.cpp rwlock-reader-pref.cpp -w -o rwlock-reader-pref -lpthread
...
g++ test-writer-pref.cpp rwlock-writer-pref.cpp -w -o rwlock-writer-pref -lpthread
